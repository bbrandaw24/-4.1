...
| v13.13 | 2026-08-27 | `3514bec` | AI 服务：推理接口骨架与部署（健康检查 / 模型状态 / 预测接口 + Docker 化） |
| v13.14 | 2026-08-27 | 本提交 | feat(ai)：Riseholme-2021 数据集训练与纯 NumPy 推理集成（4 类 MLP，测试集准确率 0.8123，含数据整理/训练/推理全链路） |
